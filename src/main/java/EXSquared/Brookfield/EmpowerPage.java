...
public class EmpowerPage extends BRPHelper {

	@FindBy(xpath = ".//div[contains(@class,'breadcrumb')]//a[text()='Empower']")
	private WebElement futureOfHomeSubtitle;

	public EmpowerPage(Config testConfig) {
		...
		Browser.waitForPageLoad(testConfig, futureOfHomeSubtitle);
	}
